...
//             <div
//               ref={ref}
//               className="card relative h-screen w-[100%] rounded-[30px] border border-1 border-zinc-300 flex items-start justify-center py-24 gap-16 overflow-hidden"
//             >
//               <div className="video h-screen w-full bg-zinc-100 absolute top-0">
//                 <video
//                   autoPlay
//                   loop
//                   muted
...
//                   quite ready to close. Group, label, and color code your tabs
//                   to <br /> stay organized and work faster.
//                 </p>
//               </div>
//             </div>
...
//                   Chrome is built to work with your <br /> device across
//                   platforms. That means <br /> a smooth experience on whatever{" "}
//                   <br /> you’re working with.
//                 </p>
...
//       gsap.to(el, {
//         duration: 4,
//         y: el.classList.contains("video") ? 220 : 0,
//         x: el.classList.contains("video") ? -70 : 50,
//         scrollTrigger: {
//           trigger: el,
//           scrub: true,
...
//             <div
//               ref={ref}
//               className="card relative h-screen w-[90%] rounded-[30px] border border-1 border-zinc-300 flex items-start justify-center py-24 gap-40 overflow-hidden"
//             >
//               <div className="video h-screen w-full top-0 bg-zinc-100 absolute border-none rounded-tr-full">
//                 <video
//                   autoPlay
//                   loop
//                   muted
...
//             <div
//               ref={ref}
//               className="card3 relative h-full w-[87%]  rounded-[30px] bg-green-600 border border-1 border-zinc-300 flex items-start justify-center overflow-hidden"
//             >
//               <div className="pl-16 w-[35%] h-screen pt-16">
//                 <h3 className="text-3xl font-bold text-white">
//                   Optimized for <br /> your device
...
//                 </div>
//               </div>
//               <div className="h-[100%] w-[65%]  mt-20  object-contain ">
//                 <img
//                   src="https://www.google.com/chrome/static/images/homepage/fast/devices_desktop-2x.webp"
//                   alt=""
//                 />
