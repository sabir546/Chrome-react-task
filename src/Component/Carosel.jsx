...
//         ref={swiperRef}
//         className="mySwiper"
//         autoplay={{ delay: 4000 }} // Autoplay configuration
...
//       </Swiper>
//       <div className="buttons w-[350px] h-[100px]">
//         <button className="px-2 float-end font-bolder rounded-full text-[40px] text-blue-700 py-2 bg-blue-100 swiper-button-next">
//           <IoIosArrowForward />
//         </button>
//         <button className="px-2 float-end font-bolder text-[40px] mr-4 rounded-full text-blue-700 py-2 bg-blue-100 swiper-button-prev">
//           <IoIosArrowBack />
//         </button>
//       </div>
//     </div>
